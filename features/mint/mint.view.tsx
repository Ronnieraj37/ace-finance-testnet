...
function MintView() {
	...
	const [selectedToken, setSelectedToken] = useState<StandardToken>(
		TOKENS[0]
	);
				...
				<div className='space-y-6'>
					...
					<div className='flex flex-col gap-2'>
						...
						<SingleSelect
							...
							isOpen={isSelectOpen}
							className='border !border-select-border h-[48px]'
					...
					<div className='flex flex-col gap-2'>
						...
						<div className='relative'>
							<input
								id='amount'
								type='text'
								className='w-full h-12 px-4 py-2 border !border-select-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary pr-20 text-white'
								value={amount}
